...
class CustomExpansionTile extends StatefulWidget {
  ...
  })  : assert(initiallyExpanded != null, 'initiallyExpanded must not be null'),
        assert(headerPadding != null, 'headerPadding must not be null'),
        assert(contentPadding != null, 'contentPadding must not be null'),
        assert(trailingIcon != null, 'trailingIcon must not be null'),
        assert(trailingRotation != null, 'trailingRotation must not be null'),
        super(key: key);
...
class CustomExpansionTileDecoration {
  const CustomExpansionTileDecoration({
    ...
    this.dividerThickness,
        ...
        assert(borderRadius != null, 'borderRadius must not be null');
